...
BasicGame.MainMenu.prototype = {
  ...
  create: function () {
    ...
    this.loadingText = this.add.text(this.game.width / 2, this.game.height / 2 + 80, "Press Z or tap/click game to start", { font: "20px monospace", fill: "#fff", stroke: "black", strokeThickness: 5 });
