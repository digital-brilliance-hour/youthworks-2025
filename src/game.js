...
BasicGame.Game.prototype = {
  ...
  setupAudio: function () {
  this.explosionSFX = this.add.audio('explosion', 0.3, false);
  this.playerExplosionSFX = this.add.audio('playerExplosion', 0.3, false);
  this.enemyFireSFX = this.add.audio('enemyFire', 0.3, false);
  this.playerFireSFX = this.add.audio('playerFire', 0.3, false);
  this.powerUpSFX = this.add.audio('powerUp', 0.3, false);
